 ...
 * @final
 */
class DependencyInjectionContainer_96c72b3d71b8fea48eb8b83aa9a87794da136f4e extends Container
{
    private $parameters = [];
    private $getService;
    ...
    public function __construct()
    {
        ...
        $this->methodMap = [
            ...
            'TYPO3\\CMS\\Dashboard\\Widgets\\DocumentationGettingStartedWidget' => 'getDocumentationGettingStartedWidgetService',
            'TYPO3\\CMS\\Dashboard\\Widgets\\DocumentationTSconfigReferenceWidget' => 'getDocumentationTSconfigReferenceWidgetService',
            'TYPO3\\CMS\\Dashboard\\Widgets\\DocumentationTypoScriptReference' => 'getDocumentationTypoScriptReferenceService',
            'TYPO3\\CMS\\Dashboard\\Widgets\\FailedLoginsWidget' => 'getFailedLoginsWidgetService',
            'TYPO3\\CMS\\Dashboard\\Widgets\\SysLogErrorsWidget' => 'getSysLogErrorsWidgetService',
            'TYPO3\\CMS\\Dashboard\\Widgets\\T3GeneralInformation' => 'getT3GeneralInformationService',
            'TYPO3\\CMS\\Dashboard\\Widgets\\T3NewsWidget' => 'getT3NewsWidgetService',
            'TYPO3\\CMS\\Dashboard\\Widgets\\T3SecurityAdvisoriesWidget' => 'getT3SecurityAdvisoriesWidgetService',
            'TYPO3\\CMS\\Dashboard\\Widgets\\TypeOfUsersWidget' => 'getTypeOfUsersWidgetService',
    ...
    public function getRemovedIds(): array
    {
        return [
            ...
            'TYPO3\\CMS\\Core\\Page\\AssetRenderer' => true,
    ...
    {
        return $this->services['TYPO3\\CMS\\Adminpanel\\Service\\EventDispatcher'] = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\TYPO3\CMS\Adminpanel\Service\EventDispatcher::class, ($this->services['TYPO3\\CMS\\Core\\EventDispatcher\\ListenerProvider'] ?? $this->getListenerProviderService()));
    }
    ...
    protected function getListenerProviderService()
    {
        ...
        $instance->addListener('TYPO3\\CMS\\Core\\Database\\Event\\AlterTableDefinitionStatementsEvent', 'TYPO3\\CMS\\Core\\Cache\\DatabaseSchemaService', 'addCachingFrameworkDatabaseSchema');
        $instance->addListener('TYPO3\\CMS\\Core\\Database\\Event\\AlterTableDefinitionStatementsEvent', 'TYPO3\\CMS\\Core\\Category\\CategoryRegistry', 'addCategoryDatabaseSchema');
        $instance->addListener('TYPO3\\CMS\\Core\\Database\\Event\\AlterTableDefinitionStatementsEvent', 'TYPO3\\CMS\\Core\\Compatibility\\SlotReplacement', 'onSqlReaderEmitTablesDefinitionIsBeingBuiltSignal');
        $instance->addListener('TYPO3\\CMS\\Core\\Resource\\Event\\AfterFileAddedToIndexEvent', 'TYPO3\\CMS\\Core\\Compatibility\\SlotReplacement', 'onFileIndexRepositoryRecordCreated');
        $instance->addListener('TYPO3\\CMS\\Core\\Resource\\Event\\AfterFileRemovedFromIndexEvent', 'TYPO3\\CMS\\Core\\Compatibility\\SlotReplacement', 'onFileIndexRepositoryRecordDeleted');
        $instance->addListener('TYPO3\\CMS\\Core\\Resource\\Event\\AfterFileMarkedAsMissingEvent', 'TYPO3\\CMS\\Core\\Compatibility\\SlotReplacement', 'onFileIndexRepositoryRecordMarkedAsMissing');
        $instance->addListener('TYPO3\\CMS\\Core\\Resource\\Event\\AfterFileUpdatedInIndexEvent', 'TYPO3\\CMS\\Core\\Compatibility\\SlotReplacement', 'onFileIndexRepositoryRecordUpdated');
        $instance->addListener('TYPO3\\CMS\\Core\\Resource\\Event\\AfterFileProcessingEvent', 'TYPO3\\CMS\\Core\\Compatibility\\SlotReplacement', 'onFileProcessingServiceEmitPostFileProcessSignal');
        $instance->addListener('TYPO3\\CMS\\Core\\Resource\\Event\\BeforeFileProcessingEvent', 'TYPO3\\CMS\\Core\\Compatibility\\SlotReplacement', 'onFileProcessingServiceEmitPreFileProcessSignal');
        $instance->addListener('TYPO3\\CMS\\Core\\Resource\\Event\\BeforeFileProcessingEvent', 'TYPO3\\CMS\\Core\\Resource\\OnlineMedia\\Processing\\PreviewProcessing', 'processFile');
        $instance->addListener('TYPO3\\CMS\\Core\\Resource\\Event\\AfterFileMetaDataCreatedEvent', 'TYPO3\\CMS\\Core\\Compatibility\\SlotReplacement', 'onMetaDataRepositoryRecordCreated');
        $instance->addListener('TYPO3\\CMS\\Core\\Resource\\Event\\AfterFileMetaDataDeletedEvent', 'TYPO3\\CMS\\Core\\Compatibility\\SlotReplacement', 'onMetaDataRepositoryRecordDeleted');
        $instance->addListener('TYPO3\\CMS\\Core\\Resource\\Event\\EnrichFileMetaDataEvent', 'TYPO3\\CMS\\Core\\Compatibility\\SlotReplacement', 'onMetaDataRepositoryRecordPostRetrieval');
        $instance->addListener('TYPO3\\CMS\\Core\\Resource\\Event\\EnrichFileMetaDataEvent', 'TYPO3\\CMS\\Frontend\\Aspect\\FileMetadataOverlayAspect', 'languageAndWorkspaceOverlay');
        $instance->addListener('TYPO3\\CMS\\Core\\Resource\\Event\\AfterFileMetaDataUpdatedEvent', 'TYPO3\\CMS\\Core\\Compatibility\\SlotReplacement', 'onMetaDataRepositoryRecordUpdated');
        $instance->addListener('TYPO3\\CMS\\Core\\Resource\\Event\\AfterResourceStorageInitializationEvent', 'TYPO3\\CMS\\Core\\Resource\\Security\\StoragePermissionsAspect', 'addUserPermissionsToStorage');
        $instance->addListener('TYPO3\\CMS\\Core\\Resource\\Event\\AfterResourceStorageInitializationEvent', 'TYPO3\\CMS\\Core\\Compatibility\\SlotReplacement', 'onResourceFactoryPostProcessStorage');
        $instance->addListener('TYPO3\\CMS\\Core\\Resource\\Event\\BeforeResourceStorageInitializationEvent', 'TYPO3\\CMS\\Core\\Compatibility\\SlotReplacement', 'onResourceFactoryPreProcessStorage');
        $instance->addListener('TYPO3\\CMS\\Core\\Resource\\Event\\AfterFileAddedEvent', 'TYPO3\\CMS\\Core\\Resource\\Processing\\FileDeletionAspect', 'cleanupProcessedFilesPostFileAdd');
        $instance->addListener('TYPO3\\CMS\\Core\\Resource\\Event\\AfterFileAddedEvent', 'TYPO3\\CMS\\Core\\Compatibility\\SlotReplacement', 'onResourceStorageEmitPostFileAddSignal');
        $instance->addListener('TYPO3\\CMS\\Core\\Resource\\Event\\AfterFileCopiedEvent', 'TYPO3\\CMS\\Core\\Compatibility\\SlotReplacement', 'onResourceStorageEmitPostFileCopySignal');
        $instance->addListener('TYPO3\\CMS\\Core\\Resource\\Event\\AfterFileCreatedEvent', 'TYPO3\\CMS\\Core\\Compatibility\\SlotReplacement', 'onResourceStorageEmitPostFileCreateSignal');
        $instance->addListener('TYPO3\\CMS\\Core\\Resource\\Event\\AfterFileDeletedEvent', 'TYPO3\\CMS\\Core\\Resource\\Processing\\FileDeletionAspect', 'removeFromRepositoryAfterFileDeleted');
        $instance->addListener('TYPO3\\CMS\\Core\\Resource\\Event\\AfterFileDeletedEvent', 'TYPO3\\CMS\\Core\\Compatibility\\SlotReplacement', 'onResourceStorageEmitPostFileDeleteSignal');
        $instance->addListener('TYPO3\\CMS\\Core\\Resource\\Event\\AfterFileMovedEvent', 'TYPO3\\CMS\\Core\\Compatibility\\SlotReplacement', 'onResourceStorageEmitPostFileMoveSignal');
        $instance->addListener('TYPO3\\CMS\\Core\\Resource\\Event\\AfterFileRenamedEvent', 'TYPO3\\CMS\\Core\\Compatibility\\SlotReplacement', 'onResourceStorageEmitPostFileRenameSignal');
        $instance->addListener('TYPO3\\CMS\\Core\\Resource\\Event\\AfterFileReplacedEvent', 'TYPO3\\CMS\\Core\\Resource\\Processing\\FileDeletionAspect', 'cleanupProcessedFilesPostFileReplace');
        $instance->addListener('TYPO3\\CMS\\Core\\Resource\\Event\\AfterFileReplacedEvent', 'TYPO3\\CMS\\Core\\Compatibility\\SlotReplacement', 'onResourceStorageEmitPostFileReplaceSignal');
        $instance->addListener('TYPO3\\CMS\\Core\\Resource\\Event\\AfterFileContentsSetEvent', 'TYPO3\\CMS\\Core\\Compatibility\\SlotReplacement', 'onResourceStorageEmitPostFileSetContentsSignal');
        $instance->addListener('TYPO3\\CMS\\Core\\Resource\\Event\\AfterFolderAddedEvent', 'TYPO3\\CMS\\Core\\Compatibility\\SlotReplacement', 'onResourceStorageEmitPostFolderAddSignal');
        $instance->addListener('TYPO3\\CMS\\Core\\Resource\\Event\\AfterFolderCopiedEvent', 'TYPO3\\CMS\\Core\\Compatibility\\SlotReplacement', 'onResourceStorageEmitPostFolderCopySignal');
        $instance->addListener('TYPO3\\CMS\\Core\\Resource\\Event\\AfterFolderDeletedEvent', 'TYPO3\\CMS\\Core\\Compatibility\\SlotReplacement', 'onResourceStorageEmitPostFolderDeleteSignal');
        $instance->addListener('TYPO3\\CMS\\Core\\Resource\\Event\\AfterFolderMovedEvent', 'TYPO3\\CMS\\Core\\Compatibility\\SlotReplacement', 'onResourceStorageEmitPostFolderMoveSignal');
        $instance->addListener('TYPO3\\CMS\\Core\\Resource\\Event\\AfterFolderRenamedEvent', 'TYPO3\\CMS\\Core\\Compatibility\\SlotReplacement', 'onResourceStorageEmitPostFolderRenameSignal');
        $instance->addListener('TYPO3\\CMS\\Core\\Resource\\Event\\BeforeFileAddedEvent', 'TYPO3\\CMS\\Form\\Slot\\FilePersistenceSlot', 'onPreFileAdd');
        $instance->addListener('TYPO3\\CMS\\Core\\Resource\\Event\\BeforeFileAddedEvent', 'TYPO3\\CMS\\Core\\Compatibility\\SlotReplacement', 'onResourceStorageEmitPreFileAddSignal');
        $instance->addListener('TYPO3\\CMS\\Core\\Resource\\Event\\BeforeFileCopiedEvent', 'TYPO3\\CMS\\Core\\Compatibility\\SlotReplacement', 'onResourceStorageEmitPreFileCopySignal');
        $instance->addListener('TYPO3\\CMS\\Core\\Resource\\Event\\BeforeFileCreatedEvent', 'TYPO3\\CMS\\Form\\Slot\\FilePersistenceSlot', 'onPreFileCreate');
        $instance->addListener('TYPO3\\CMS\\Core\\Resource\\Event\\BeforeFileCreatedEvent', 'TYPO3\\CMS\\Core\\Compatibility\\SlotReplacement', 'onResourceStorageEmitPreFileCreateSignal');
        $instance->addListener('TYPO3\\CMS\\Core\\Resource\\Event\\BeforeFileDeletedEvent', 'TYPO3\\CMS\\Core\\Compatibility\\SlotReplacement', 'onResourceStorageEmitPreFileDeleteSignal');
        $instance->addListener('TYPO3\\CMS\\Core\\Resource\\Event\\BeforeFileMovedEvent', 'TYPO3\\CMS\\Form\\Slot\\FilePersistenceSlot', 'onPreFileMove');
        $instance->addListener('TYPO3\\CMS\\Core\\Resource\\Event\\BeforeFileMovedEvent', 'TYPO3\\CMS\\Core\\Compatibility\\SlotReplacement', 'onResourceStorageEmitPreFileMoveSignal');
        $instance->addListener('TYPO3\\CMS\\Core\\Resource\\Event\\BeforeFileRenamedEvent', 'TYPO3\\CMS\\Form\\Slot\\FilePersistenceSlot', 'onPreFileRename');
        $instance->addListener('TYPO3\\CMS\\Core\\Resource\\Event\\BeforeFileRenamedEvent', 'TYPO3\\CMS\\Core\\Compatibility\\SlotReplacement', 'onResourceStorageEmitPreFileRenameSignal');
        $instance->addListener('TYPO3\\CMS\\Core\\Resource\\Event\\BeforeFileReplacedEvent', 'TYPO3\\CMS\\Form\\Slot\\FilePersistenceSlot', 'onPreFileReplace');
        $instance->addListener('TYPO3\\CMS\\Core\\Resource\\Event\\BeforeFileReplacedEvent', 'TYPO3\\CMS\\Core\\Compatibility\\SlotReplacement', 'onResourceStorageEmitPreFileReplaceSignal');
        $instance->addListener('TYPO3\\CMS\\Core\\Resource\\Event\\BeforeFileContentsSetEvent', 'TYPO3\\CMS\\Form\\Slot\\FilePersistenceSlot', 'onPreFileSetContents');
        $instance->addListener('TYPO3\\CMS\\Core\\Resource\\Event\\BeforeFileContentsSetEvent', 'TYPO3\\CMS\\Core\\Compatibility\\SlotReplacement', 'onResourceStorageEmitPreFileSetContentsSignal');
        $instance->addListener('TYPO3\\CMS\\Core\\Resource\\Event\\BeforeFolderAddedEvent', 'TYPO3\\CMS\\Core\\Compatibility\\SlotReplacement', 'onResourceStorageEmitPreFolderAddSignal');
        $instance->addListener('TYPO3\\CMS\\Core\\Resource\\Event\\BeforeFolderCopiedEvent', 'TYPO3\\CMS\\Core\\Compatibility\\SlotReplacement', 'onResourceStorageEmitPreFolderCopySignal');
        $instance->addListener('TYPO3\\CMS\\Core\\Resource\\Event\\BeforeFolderDeletedEvent', 'TYPO3\\CMS\\Core\\Compatibility\\SlotReplacement', 'onResourceStorageEmitPreFolderDeleteSignal');
        $instance->addListener('TYPO3\\CMS\\Core\\Resource\\Event\\BeforeFolderMovedEvent', 'TYPO3\\CMS\\Core\\Compatibility\\SlotReplacement', 'onResourceStorageEmitPreFolderMoveSignal');
        $instance->addListener('TYPO3\\CMS\\Core\\Resource\\Event\\BeforeFolderRenamedEvent', 'TYPO3\\CMS\\Core\\Compatibility\\SlotReplacement', 'onResourceStorageEmitPreFolderRenameSignal');
        $instance->addListener('TYPO3\\CMS\\Core\\Resource\\Event\\GeneratePublicUrlForResourceEvent', 'TYPO3\\CMS\\Core\\Compatibility\\SlotReplacement', 'onResourceStorageEmitPreGeneratePublicUrlSignal');
        $instance->addListener('TYPO3\\CMS\\Core\\Resource\\Event\\SanitizeFileNameEvent', 'TYPO3\\CMS\\Core\\Compatibility\\SlotReplacement', 'onResourceStorageEmitSanitizeFileNameSignal');
        $instance->addListener('TYPO3\\CMS\\Core\\DataHandling\\Event\\AppendLinkHandlerElementsEvent', 'TYPO3\\CMS\\Core\\Compatibility\\SlotReplacement', 'onSoftReferenceIndexSetTypoLinkPartsElementSignal');
        $instance->addListener('TYPO3\\CMS\\Core\\Imaging\\Event\\ModifyIconForResourcePropertiesEvent', 'TYPO3\\CMS\\Core\\Compatibility\\SlotReplacement', 'onIconFactoryEmitBuildIconForResourceSignal');
        $instance->addListener('TYPO3\\CMS\\Core\\Configuration\\Event\\AfterTcaCompilationEvent', 'TYPO3\\CMS\\Core\\Compatibility\\SlotReplacement', 'onExtensionManagementUtilityTcaIsBeingBuilt');
        $instance->addListener('TYPO3\\CMS\\Core\\Tree\\Event\\ModifyTreeDataEvent', 'TYPO3\\CMS\\Backend\\Security\\CategoryPermissionsAspect', 'addUserPermissionsToCategoryTreeData');
        $instance->addListener('TYPO3\\CMS\\Core\\Tree\\Event\\ModifyTreeDataEvent', 'TYPO3\\CMS\\Core\\Compatibility\\SlotReplacement', 'onDatabaseTreeDataProviderEmitPostProcessTreeDataSignal');
        $instance->addListener('TYPO3\\CMS\\Core\\Package\\Event\\PackagesMayHaveChangedEvent', 'TYPO3\\CMS\\Core\\Compatibility\\SlotReplacement', 'packagesMayHaveChanged');
        $instance->addListener('TYPO3\\CMS\\Core\\Mail\\Event\\AfterMailerInitializationEvent', 'TYPO3\\CMS\\Core\\Compatibility\\SlotReplacement', 'postInitializeMailer');
        $instance->addListener('TYPO3\\CMS\\Core\\Package\\Event\\AfterPackageActivationEvent', 'TYPO3\\CMS\\Extensionmanager\\Compatibility\\SlotReplacement', 'afterExtensionInstallSlot');
        $instance->addListener('TYPO3\\CMS\\Core\\Package\\Event\\AfterPackageActivationEvent', 'TYPO3\\CMS\\Core\\Core\\ClassLoadingInformation', 'updateClassLoadingInformationAfterPackageActivation');
        $instance->addListener('TYPO3\\CMS\\Core\\Package\\Event\\AfterPackageDeactivationEvent', 'TYPO3\\CMS\\Extensionmanager\\Compatibility\\SlotReplacement', 'afterExtensionUninstallSlot');
        $instance->addListener('TYPO3\\CMS\\Core\\Package\\Event\\AfterPackageDeactivationEvent', 'TYPO3\\CMS\\Core\\Core\\ClassLoadingInformation', 'updateClassLoadingInformationAfterPackageDeactivation');
        $instance->addListener('TYPO3\\CMS\\Extbase\\Event\\Mvc\\AfterRequestDispatchedEvent', 'TYPO3\\CMS\\Extbase\\Compatibility\\SlotReplacement', 'afterRequestDispatched');
        $instance->addListener('TYPO3\\CMS\\Extbase\\Event\\Mvc\\BeforeActionCallEvent', 'TYPO3\\CMS\\Extbase\\Compatibility\\SlotReplacement', 'beforeCallActionMethod');
        $instance->addListener('TYPO3\\CMS\\Extbase\\Event\\Persistence\\AfterObjectThawedEvent', 'TYPO3\\CMS\\Extbase\\Compatibility\\SlotReplacement', 'afterDataMappedForObject');
        $instance->addListener('TYPO3\\CMS\\Extbase\\Event\\Persistence\\ModifyQueryBeforeFetchingObjectDataEvent', 'TYPO3\\CMS\\Extbase\\Compatibility\\SlotReplacement', 'emitBeforeGettingObjectDataSignal');
        $instance->addListener('TYPO3\\CMS\\Extbase\\Event\\Persistence\\ModifyResultAfterFetchingObjectDataEvent', 'TYPO3\\CMS\\Extbase\\Compatibility\\SlotReplacement', 'emitAfterGettingObjectDataSignal');
        $instance->addListener('TYPO3\\CMS\\Extbase\\Event\\Persistence\\EntityFinalizedAfterPersistenceEvent', 'TYPO3\\CMS\\Extbase\\Compatibility\\SlotReplacement', 'emitEndInsertObjectSignal');
        $instance->addListener('TYPO3\\CMS\\Extbase\\Event\\Persistence\\EntityAddedToPersistenceEvent', 'TYPO3\\CMS\\Extbase\\Compatibility\\SlotReplacement', 'emitAfterInsertObjectSignal');
        $instance->addListener('TYPO3\\CMS\\Extbase\\Event\\Persistence\\EntityUpdatedInPersistenceEvent', 'TYPO3\\CMS\\Extbase\\Compatibility\\SlotReplacement', 'emitAfterUpdateObjectSignal');
        $instance->addListener('TYPO3\\CMS\\Extbase\\Event\\Persistence\\EntityRemovedFromPersistenceEvent', 'TYPO3\\CMS\\Extbase\\Compatibility\\SlotReplacement', 'emitAfterRemoveObjectSignal');
        $instance->addListener('TYPO3\\CMS\\Extbase\\Event\\Persistence\\EntityPersistedEvent', 'TYPO3\\CMS\\Extbase\\Compatibility\\SlotReplacement', 'emitAfterPersistObjectSignal');
        $instance->addListener('TYPO3\\CMS\\Impexp\\Event\\BeforeImportEvent', 'TYPO3\\CMS\\Impexp\\Compatibility\\SlotReplacement', 'emitAfterImportExportInitialisationSignal');
        $instance->addListener('TYPO3\\CMS\\Backend\\Backend\\Event\\SystemInformationToolbarCollectorEvent', 'TYPO3\\CMS\\Belog\\Controller\\SystemInformationController', 'appendMessage');
        $instance->addListener('TYPO3\\CMS\\Backend\\Backend\\Event\\SystemInformationToolbarCollectorEvent', 'TYPO3\\CMS\\Install\\SystemInformation\\Typo3VersionMessage', 'appendMessage');
        $instance->addListener('TYPO3\\CMS\\Backend\\Backend\\Event\\SystemInformationToolbarCollectorEvent', 'TYPO3\\CMS\\Backend\\Compatibility\\SlotReplacement', 'onSystemInformationToolbarEvent');
        $instance->addListener('TYPO3\\CMS\\Install\\Service\\Event\\ModifyLanguagePackRemoteBaseUrlEvent', 'TYPO3\\CMS\\Install\\Compatibility\\SlotReplacement', 'onLanguagePackProcessMirrorUrl');
        $instance->addListener('TYPO3\\CMS\\Backend\\LoginProvider\\Event\\ModifyPageLayoutOnLoginProviderSelectionEvent', 'TYPO3\\CMS\\Backend\\Compatibility\\SlotReplacement', 'onLoginProviderGetPageRenderer');
        $instance->addListener('TYPO3\\CMS\\Core\\Configuration\\Event\\ModifyLoadedPageTsConfigEvent', 'TYPO3\\CMS\\Backend\\Compatibility\\SlotReplacement', 'emitGetPagesTSconfigPreIncludeSignalBackendUtility');
        $instance->addListener('TYPO3\\CMS\\Backend\\Controller\\Event\\BeforeFormEnginePageInitializedEvent', 'TYPO3\\CMS\\Backend\\Compatibility\\SlotReplacement', 'onPreInitEditDocumentController');
        $instance->addListener('TYPO3\\CMS\\Backend\\Controller\\Event\\AfterFormEnginePageInitializedEvent', 'TYPO3\\CMS\\Backend\\Compatibility\\SlotReplacement', 'onInitEditDocumentController');
        $instance->addListener('TYPO3\\CMS\\Backend\\View\\Event\\AfterSectionMarkupGeneratedEvent', 'TYPO3\\CMS\\Backend\\View\\PageLayoutViewDrawEmptyColposContent', NULL);
        $instance->addListener('TYPO3\\CMS\\Backend\\History\\Event\\BeforeHistoryRollbackStartEvent', 'TYPO3\\CMS\\Redirects\\EventListener\\RecordHistoryRollbackEventsListener', 'beforeHistoryRollbackStartEvent');
        $instance->addListener('TYPO3\\CMS\\Backend\\History\\Event\\AfterHistoryRollbackFinishedEvent', 'TYPO3\\CMS\\Redirects\\EventListener\\RecordHistoryRollbackEventsListener', 'afterHistoryRollbackFinishedEvent');
        $instance->addListener('TYPO3\\CMS\\Backend\\Authentication\\Event\\SwitchUserEvent', 'TYPO3\\CMS\\Beuser\\Compatibility\\SlotReplacement', 'onSwitchUser');
        $instance->addListener('TYPO3\\CMS\\Core\\Package\\Event\\BeforePackageActivationEvent', 'TYPO3\\CMS\\Extensionmanager\\Compatibility\\SlotReplacement', 'emitWillInstallExtensionsSignal');
        $instance->addListener('TYPO3\\CMS\\Extensionmanager\\Event\\AfterExtensionDatabaseContentHasBeenImportedEvent', 'TYPO3\\CMS\\Extensionmanager\\Compatibility\\SlotReplacement', 'emitAfterExtensionT3DImportSignal');
        $instance->addListener('TYPO3\\CMS\\Extensionmanager\\Event\\AfterExtensionStaticDatabaseContentHasBeenImportedEvent', 'TYPO3\\CMS\\Extensionmanager\\Compatibility\\SlotReplacement', 'emitAfterExtensionStaticSqlImportSignal');
        $instance->addListener('TYPO3\\CMS\\Extensionmanager\\Event\\AfterExtensionFilesHaveBeenImportedEvent', 'TYPO3\\CMS\\Extensionmanager\\Compatibility\\SlotReplacement', 'emitAfterExtensionFileImportSignal');
        $instance->addListener('TYPO3\\CMS\\Extensionmanager\\Event\\AvailableActionsForExtensionEvent', 'TYPO3\\CMS\\Extensionmanager\\Compatibility\\SlotReplacement', 'emitProcessActionsSignal');
        $instance->addListener('TYPO3\\CMS\\Seo\\Event\\ModifyUrlForCanonicalTagEvent', 'TYPO3\\CMS\\Seo\\Compatibility\\SlotReplacement', 'beforeGeneratingCanonical');
        $instance->addListener('TYPO3\\CMS\\Frontend\\Event\\ModifyHrefLangTagsEvent', 'TYPO3\\CMS\\Seo\\HrefLang\\HrefLangGenerator', NULL);
    ...
    {
        return $this->services['TYPO3\\CMS\\Core\\Resource\\Index\\FileIndexRepository'] = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\TYPO3\CMS\Core\Resource\Index\FileIndexRepository::class, ($this->services['Psr\\EventDispatcher\\EventDispatcherInterface_decorated_1'] ?? $this->getEventDispatcherInterfaceDecorated1Service()));
    }
    ...
    {
        return $this->services['TYPO3\\CMS\\Core\\Resource\\Index\\MetaDataRepository'] = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\TYPO3\CMS\Core\Resource\Index\MetaDataRepository::class, ($this->services['Psr\\EventDispatcher\\EventDispatcherInterface_decorated_1'] ?? $this->getEventDispatcherInterfaceDecorated1Service()));
    }
    ...
    protected function getWidgetRegistryService()
    {
        ...
        $instance->registerWidget('docGettingStarted', 'TYPO3\\CMS\\Dashboard\\Widgets\\DocumentationGettingStartedWidget', [0 => 'documentation']);
        $instance->registerWidget('docTSconfig', 'TYPO3\\CMS\\Dashboard\\Widgets\\DocumentationTSconfigReferenceWidget', [0 => 'documentation']);
        $instance->registerWidget('docTypoScriptReference', 'TYPO3\\CMS\\Dashboard\\Widgets\\DocumentationTypoScriptReference', [0 => 'documentation']);
        $instance->registerWidget('failedLogins', 'TYPO3\\CMS\\Dashboard\\Widgets\\FailedLoginsWidget', [0 => 'general']);
        $instance->registerWidget('sysLogErrors', 'TYPO3\\CMS\\Dashboard\\Widgets\\SysLogErrorsWidget', [0 => 'systemInfo']);
        $instance->registerWidget('t3information', 'TYPO3\\CMS\\Dashboard\\Widgets\\T3GeneralInformation', [0 => 'general']);
        $instance->registerWidget('t3news', 'TYPO3\\CMS\\Dashboard\\Widgets\\T3NewsWidget', [0 => 'typo3']);
        $instance->registerWidget('t3securityAdvisories', 'TYPO3\\CMS\\Dashboard\\Widgets\\T3SecurityAdvisoriesWidget', [0 => 'typo3']);
        $instance->registerWidget('typeOfUsers', 'TYPO3\\CMS\\Dashboard\\Widgets\\TypeOfUsersWidget', [0 => 'systemInfo']);

        return $instance;
    }

    /**
     * Gets the public 'TYPO3\CMS\Dashboard\Widgets\DocumentationGettingStartedWidget' autowired service.
     *
     * @return \TYPO3\CMS\Dashboard\Widgets\DocumentationGettingStartedWidget
     */
    protected function getDocumentationGettingStartedWidgetService()
    {
        return \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\TYPO3\CMS\Dashboard\Widgets\DocumentationGettingStartedWidget::class, 'docGettingStarted');
    }

    /**
     * Gets the public 'TYPO3\CMS\Dashboard\Widgets\DocumentationTSconfigReferenceWidget' autowired service.
     *
     * @return \TYPO3\CMS\Dashboard\Widgets\DocumentationTSconfigReferenceWidget
     */
    protected function getDocumentationTSconfigReferenceWidgetService()
    {
        return \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\TYPO3\CMS\Dashboard\Widgets\DocumentationTSconfigReferenceWidget::class, 'docTSconfig');
    }

    /**
     * Gets the public 'TYPO3\CMS\Dashboard\Widgets\DocumentationTypoScriptReference' autowired service.
     *
     * @return \TYPO3\CMS\Dashboard\Widgets\DocumentationTypoScriptReference
     */
    protected function getDocumentationTypoScriptReferenceService()
    {
        return \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\TYPO3\CMS\Dashboard\Widgets\DocumentationTypoScriptReference::class, 'docTypoScriptReference');
    }

    /**
     * Gets the public 'TYPO3\CMS\Dashboard\Widgets\FailedLoginsWidget' autowired service.
     *
     * @return \TYPO3\CMS\Dashboard\Widgets\FailedLoginsWidget
     */
    protected function getFailedLoginsWidgetService()
    {
        return \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\TYPO3\CMS\Dashboard\Widgets\FailedLoginsWidget::class, 'failedLogins');
    }

    /**
     * Gets the public 'TYPO3\CMS\Dashboard\Widgets\SysLogErrorsWidget' autowired service.
     *
     * @return \TYPO3\CMS\Dashboard\Widgets\SysLogErrorsWidget
     */
    protected function getSysLogErrorsWidgetService()
    {
        return \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\TYPO3\CMS\Dashboard\Widgets\SysLogErrorsWidget::class, 'sysLogErrors');
    }

    /**
     * Gets the public 'TYPO3\CMS\Dashboard\Widgets\T3GeneralInformation' autowired service.
     *
     * @return \TYPO3\CMS\Dashboard\Widgets\T3GeneralInformation
     */
    protected function getT3GeneralInformationService()
    {
        return \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\TYPO3\CMS\Dashboard\Widgets\T3GeneralInformation::class, 't3information');
    }

    /**
     * Gets the public 'TYPO3\CMS\Dashboard\Widgets\T3NewsWidget' autowired service.
     *
     * @return \TYPO3\CMS\Dashboard\Widgets\T3NewsWidget
     */
    protected function getT3NewsWidgetService()
    {
        return \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\TYPO3\CMS\Dashboard\Widgets\T3NewsWidget::class, 't3news');
    }

    /**
     * Gets the public 'TYPO3\CMS\Dashboard\Widgets\T3SecurityAdvisoriesWidget' autowired service.
     *
     * @return \TYPO3\CMS\Dashboard\Widgets\T3SecurityAdvisoriesWidget
     */
    protected function getT3SecurityAdvisoriesWidgetService()
    {
        return \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\TYPO3\CMS\Dashboard\Widgets\T3SecurityAdvisoriesWidget::class, 't3securityAdvisories');
    }

    /**
     * Gets the public 'TYPO3\CMS\Dashboard\Widgets\TypeOfUsersWidget' autowired service.
     *
     * @return \TYPO3\CMS\Dashboard\Widgets\TypeOfUsersWidget
     */
    protected function getTypeOfUsersWidgetService()
    {
        return \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\TYPO3\CMS\Dashboard\Widgets\TypeOfUsersWidget::class, 'typeOfUsers');
    }
    ...
    protected function getFileHandlingUtilityService()
    {
        ...
        $instance->injectEmConfUtility(($this->services['TYPO3\\CMS\\Extensionmanager\\Utility\\EmConfUtility'] ?? ($this->services['TYPO3\\CMS\\Extensionmanager\\Utility\\EmConfUtility'] = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\TYPO3\CMS\Extensionmanager\Utility\EmConfUtility::class))));
        $instance->injectInstallUtility(($this->services['TYPO3\\CMS\\Extensionmanager\\Utility\\InstallUtility'] ?? $this->getInstallUtilityService()));
        $instance->injectLanguageService(($this->privates['TYPO3\\CMS\\Core\\Localization\\LanguageService'] ?? ($this->privates['TYPO3\\CMS\\Core\\Localization\\LanguageService'] = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\TYPO3\CMS\Core\Localization\LanguageService::class))));
        $instance->initializeObject();
    ...
    {
        return $this->services['TYPO3\\CMS\\Redirects\\Controller\\RecordHistoryRollbackController'] = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\TYPO3\CMS\Redirects\Controller\RecordHistoryRollbackController::class, ($this->privates['TYPO3\\CMS\\Core\\Localization\\LanguageService'] ?? ($this->privates['TYPO3\\CMS\\Core\\Localization\\LanguageService'] = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\TYPO3\CMS\Core\Localization\LanguageService::class))));
    }
    ...
    protected function getDataHandlerSlugUpdateHookService()
    {
        ...
        $d = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\TYPO3\CMS\Redirects\Service\SlugService::class, $a, ($this->privates['TYPO3\\CMS\\Core\\Localization\\LanguageService'] ?? ($this->privates['TYPO3\\CMS\\Core\\Localization\\LanguageService'] = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\TYPO3\CMS\Core\Localization\LanguageService::class))), ($this->privates['TYPO3\\CMS\\Core\\Site\\SiteFinder'] ?? $this->getSiteFinderService()), $b);
    ...
    {
        return $this->privates['TYPO3\\CMS\\Core\\Information\\Typo3Information'] = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\TYPO3\CMS\Core\Information\Typo3Information::class, ($this->privates['TYPO3\\CMS\\Core\\Localization\\LanguageService'] ?? ($this->privates['TYPO3\\CMS\\Core\\Localization\\LanguageService'] = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\TYPO3\CMS\Core\Localization\LanguageService::class))));
    }
