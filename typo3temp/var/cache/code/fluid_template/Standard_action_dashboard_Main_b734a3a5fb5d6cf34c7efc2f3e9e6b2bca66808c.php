...
class Standard_action_dashboard_Main_b734a3a5fb5d6cf34c7efc2f3e9e6b2bca66808c extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output122 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('widget.additionalClasses', $array125)]);
...
$output65 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('widget.additionalClasses', $array68)]);
...
$output195 .= '" data-toggle="tab" href="#';
$array202 = array (
);
...
$output195 .= '" role="tab" aria-controls="';
$array203 = array (
);
...
$output218 .= '" role="tabpanel" aria-labelledby="';
$array225 = array (
);
